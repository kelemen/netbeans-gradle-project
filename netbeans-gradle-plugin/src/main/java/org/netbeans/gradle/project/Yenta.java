 ...
 * are
 * not (yet) their “friend”. Setting {@code <verifyRuntime>warn</verifyRuntime>}
 * allows you
 * to still compile against them and declare a regular specification version
 * dependency,
 * but be careful since this also disables checks about transitive dependency
 * usage.
 * <p>
...
public abstract class Yenta extends ModuleInstall {
     ...
     * These modules must be among your declared dependencies and they must
     * export friend packages.
     * For each such module, if you are not already a friend, you will be
     * treated as one,
     ...
     * For each such module, you will be able to access all packages, as with an
